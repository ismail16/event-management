...
class AuthOtpController extends Controller
{
    ...
    public function checkOtp(Request $request): JsonResponse
    {
        ...
        $errorMessage   = 'Your opt is not valid!';
        $expireMessage  = 'Your opt is expired plz re send otp!';
        $successMessage = 'Your OTP is Successfully Verified.';
        ...
        if ($isVerified->expire_at > now()) {
            $token = $user->createToken('temp-registration-exist');
        ...
        return response()->json($expireMessage, '404');
    }
