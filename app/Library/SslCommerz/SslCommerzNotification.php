...
//                    }
    ...
    public function invoice(array $requestData)
    {
        $header = [];

        $this->setApiUrl($this->config['apiDomain'].$this->config['apiUrl']['invoice']);
    ...
    public function setRequiredInfo(array $info)
    {
        ...
        array_key_exists('refer', $info) && $this->data['refer'] = $info['refer'];
